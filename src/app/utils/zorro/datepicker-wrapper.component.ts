            ...
            <ng-container [ngSwitch]="type">
                <ng-container *ngSwitchCase="'date'">
                    <nz-date-picker
                        ...
                        [nzShowToday]="showToday" [nzDateRender]="dateRender" [nzDisabledDate]="disableDate" 
                ...
                <ng-container *ngSwitchCase="'range'">
                    <nz-range-picker
                        ...
                        (blur)="handleBlur($event)" (focus)="handleFocus($event)" (keyup)="handleKeyup($event)" (keydown)="handleKeydown($event)"
                        [nzShowTime]="showTime" [required]="required" [nzAllowClear]="allowClear" [nzAutoFocus]="autoFocus"
                        [nzDateRender]="dateRender" [nzDisabledDate]="disableDate"
                ...
                <ng-container *ngSwitchCase="'year'">
                    <nz-year-picker
                         ...
                         [nzDisabledDate]="disableDate" [nzLocale]="locale"
                         (nzOnOpenChange)="openChange($event)">
                    </nz-year-picker>
                </ng-container>
