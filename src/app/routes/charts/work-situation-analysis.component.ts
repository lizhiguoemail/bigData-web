 ...
 */
@Component({
  selector: 'app-work-situation-analysis-chart',
  template: `
      <div class="panel-header">
          <div>就业情况分析</div>
      </div>
      <div class="chart-container">
        <div *ngIf="!loading" class="chart" id="work-situation-analysis-container"></div>
...
export class WorkSituationAnalysisChartComponent extends ChartWrapperBase implements OnInit, AfterContentInit {
  /**
   * 加载状态
   */
  ...
  render() {
    ...
    const chart = new Chart({
      container: 'work-situation-analysis-container',
      autoFit: true,
    ...
    //         ...ev.data.data,
    //         areaUrl: `api/ldl_v/analysis/situation/tree`,
    //         userUrl: `ldl_v/analysis/situation/user`
    //       },
    //       width: '600px'
    //     })
    //   }
