 ...
 */
@Component({
  selector: 'app-training-intention-analysis-chart',
  template: `
      <div class="panel-header">
          <div>培训意愿分析</div>
      </div>
      <div class="chart-container">
        <div *ngIf="!loading" class="chart" id="training-intention-analysis-container"></div>
...
export class TrainingIntentionAnalysisChartComponent extends ChartWrapperBase implements OnInit, AfterContentInit {
  /**
   * 加载状态
   */
  ...
  render() {
    ...
    const chart = new Chart({
      container: 'training-intention-analysis-container',
      autoFit: true,
    ...
    //         ...ev.data.data,
    //         areaUrl: `api/ldl_v/analysis/analyze/tree`,
    //         userUrl: `ldl_v/analysis/analyze/user`
    //       },
    //       width: '600px'
    //     })
    //   }
