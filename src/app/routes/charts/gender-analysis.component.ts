 ...
 */
@Component({
  selector: 'app-gender-analysis-chart',
  template: `
      <div class="panel-header">
          <div class="panel-header-line">性别分析</div>
      ...
      <div class="chart-container">
        <div *ngIf="!loading" class="chart" id="gender-analysis-container"></div>
...
export class GenderAnalysisChartComponent extends ChartWrapperBase implements OnInit, AfterContentInit {
  /**
   * 加载状态
   */
  ...
  render() {
    // this.data = [
    //   { type: '城镇劳动力', name: '男', value: 10 },
    //   { type: '城镇劳动力', name: '女', value: 30 },
    //   { type: '农村劳动力', name: '男', value: 141 },
    //   { type: '农村劳动力', name: '女', value: 567 },
    //   { type: '贫困劳动力', name: '男', value: 110 },
    //   { type: '贫困劳动力', name: '女', value: 20 },
    //   { type: '2020年高校毕业生', name: '男', value: 50 },
    //   { type: '2020年高校毕业生', name: '女', value: 123 },
    // ];
    const colorMap = {
      '男': '#6295f6',
      '女': '#60d9ac'
    ...
    const chart = new Chart({
      container: 'gender-analysis-container',
      autoFit: true,
      ...
      if (ev.data && ev.data.data) {
        ...
        this.openDialog({
          ...
          data: {
            ...
            ...ev.data.data,
            areaUrl: `api/ldl_v/analysis/gender/tree`,
            userUrl: `ldl_v/analysis/gender/user`
          },
          width: '600px'
        })
      }
    ...
    chart.legend('name', {
      ...
      custom: true,
      items: [
        { id: '1', name: '男', value: '男', marker: { spacing: 2, style: { fill: '#6295f6' } } },
        { id: '2', name: '女', value: '女', marker: { spacing: 2, style: { fill: '#60d9ac' } } }
      ],
      itemName: {
        style: {
          fill: '#ffffff'
